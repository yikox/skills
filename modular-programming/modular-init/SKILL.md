...
1. Identify the project root and the external or in-repo memory location the project already uses. If no memory location exists, create or propose `PM/<project-slug>/`.
...
4. Create or repair `project-management.md`, `knowledge-summary.md`, and `architecture/main-design.md`.
