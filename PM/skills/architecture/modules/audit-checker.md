...
code_paths: ["modular-programming/modular-audit/scripts/**", "modular-programming/modular-audit/tests/**"]
status: implemented
...
- `python3 -m unittest discover -s modular-programming/modular-audit/tests` 退出码 0。
