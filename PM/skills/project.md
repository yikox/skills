...
- 漂移检测:`python3 zh/living-docs/docs-sync/scripts/check_drift.py --arch-dir PM/skills/architecture`
- 本仓库文档位置:project.md 与 architecture/ 在 `PM/skills/` 下(历史沿革,非默认的项目根)

## 当前焦点

- living-docs v2 已实现并完成本仓库自迁移,待用户整体验收(REQ-20260709,设计见 architecture/changes/2026-07-09-living-docs-v2-redesign.md)。
- 验收通过后:套件进入试用期,按 acceptance-log.md 收集证据;连续 5 次全过则拆除 docs-acceptance 毕业。
...
- 2026-07-09 本仓库 PM 迁移至 living-docs 格式,v1 记账文档移入 archives/(v1- 前缀),README 重写 (本次 commit)
...
- 2026-07-04 轻量默认工作流、vocab 单一事实源、module-kind 拆分、modular-architect 角色 (22c98e8 等,详见 archives/)
- 2026-07-03 初始化项目记忆;modular-autopilot 合入 main (7e55bf5..77b70c2)

更早细节见 archives/(v1-project-management.md、project-management-history-2026.md)。
